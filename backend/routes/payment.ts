...
router.post('/initialize', authenticateToken, asyncHandler(async (req: Request, res: Response) => {
  ...
  if (!razorpayKeyId || razorpayKeyId === 'rzp_test_your_test_key_id') {
    throw createError('Payment gateway not configured. Please set up Razorpay keys.', 500);
  }
