  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900">
      ...
      <motion.div
        ...
        className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 text-white p-12 flex-col justify-center relative overflow-hidden"
      >
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-purple-100">Manage movies and shows</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                <span className="text-sm">📊</span>
              </div>
              <span className="text-purple-100">View booking analytics</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                <span className="text-sm">⚙️</span>
              </div>
              <span className="text-purple-100">System configuration</span>
            </div>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-gray-600">Access your administration panel</p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                      errors.email ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-purple-500 focus:ring-purple-500/20'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register('password')}
                    className={`block w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${
                      errors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-purple-500 focus:ring-purple-500/20'
                    }`}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 relative overflow-hidden group"
              >
                {loading ? (
