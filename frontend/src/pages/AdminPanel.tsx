    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {activeTab === 'movies' && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Manage Movies</h2>
          ...
          {activeTab === 'shows' && (
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Manage Shows</h2>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <form className="space-y-4" onSubmit={handleAddShow}>
                  ...
                  <div>
                    <label htmlFor="show_time" className="block text-sm font-medium text-gray-700">Show Time</label>
                    <input
                      id="show_time"
                      type="datetime-local"
